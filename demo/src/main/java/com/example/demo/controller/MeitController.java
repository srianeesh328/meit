...
public class MeitController {
    ...
    public ResponseEntity<ArrayList<MeitModel>> newMeit(@RequestBody MeitModel meit){
        ...
        meit.setConcept(meit.getConcept()+" \nParticipants: "+meit.getUsername());
    ...
    @PostMapping("/deleteMeit")
    public ResponseEntity<ArrayList<MeitModel>> deleteMeit(@RequestBody MeitModel meit){
        ArrayList<MeitModel> meitbyuser= new ArrayList<MeitModel>();
        System.out.println("Errasing meit:"+meit.getMeitid());
        meitService.deleteMeitByMeitId(meit.getMeitid());
    ...
    public ResponseEntity<ArrayList<MeitModel>> markPaid(@RequestBody MeitModel meit){
        ArrayList<MeitModel> meitbymeitid= new ArrayList<MeitModel>();
        System.out.println("Setting paid meit:"+meit.getMeitid()+meit.getExpense()+meit.getConcept()+meit.getUsername());
        meitbymeitid =meitService.getMeitByMeitId(meit.getMeitid());
        meitService.markMeitPaid(Integer.parseInt(meit.getExpense()));
        return ResponseEntity.ok().body(meitbymeitid);
    }
